...
def big_days_region(code: str, include_shared: bool = False) -> Dict[str, Any]:
    return big_days.region(code, include_shared)
...
def big_days_top(
    ...
    return big_days.top(region, year, month, include_shared, limit)
